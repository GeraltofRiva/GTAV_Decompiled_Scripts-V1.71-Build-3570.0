...
void func_36(Hash hParam0) // Position - 0x1767 (5991)
{
	int i;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658016[plParam0 /*467*/].f_324.f_8 != -1)
				return func_81(Global_2658016[plParam0 /*467*/].f_324.f_8) == 19;
...
void func_83() // Position - 0x26B5 (9909)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_84(var uParam0) // Position - 0x26C1 (9921)
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x2720 (10016)
{
...
BOOL func_86(int iParam0) // Position - 0x2BD4 (11220)
{
	return iParam0 == 17;
}

void func_87() // Position - 0x2BE1 (11233)
{
	var unk;
...
void func_88() // Position - 0x2C2E (11310)
{
...
BOOL func_89(Ped pedParam0) // Position - 0x2C6C (11372)
{
	int scriptTaskStatus;
...
void func_90(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2C9D (11421)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2D6D (11629)
{
	Hash statName;
...
void func_92() // Position - 0x2D89 (11657)
{
	eViewModeContext i;
...
BOOL func_93(Player plParam0) // Position - 0x2DE1 (11745)
{
...
BOOL func_94() // Position - 0x2E20 (11808)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_95(Player plParam0, int iParam1) // Position - 0x2E2E (11822)
{
	BOOL flag;
...
int func_96(int iParam0, BOOL bParam1) // Position - 0x2E87 (11911)
{
	int num;
	int num2;
...
int func_97() // Position - 0x2EC8 (11976)
{
	return Global_1574927;
}

BOOL func_98(Player plParam0) // Position - 0x2ED4 (11988)
{
	Player player;
...
BOOL func_99() // Position - 0x2EF6 (12022)
{
...
void func_100() // Position - 0x2F27 (12071)
{
...
void func_101() // Position - 0x2F55 (12117)
{
...
void func_102(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2FD1 (12241)
{
	var unk;
	float num;
...
Vector3 func_103() // Position - 0x3062 (12386)
{
	return 0.5f, -0.5f, 2f;
}

Vector3 func_104(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3075 (12405)
{
	float num;
	float num2;
	float num3;
...
float func_105(int iParam0, float fParam1) // Position - 0x30B9 (12473)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_106() // Position - 0x30F2 (12530)
{
	return -0.5f, -0.5f, 0f;
}

void func_107(int iParam0, var uParam1, var uParam2) // Position - 0x3105 (12549)
{
	if (func_4())
	{
		switch (iParam0)
...
void func_108() // Position - 0x3455 (13397)
{
	return;
}

int func_109(int iParam0, int iParam1, BOOL bParam2) // Position - 0x345D (13405)
{
	int i;
...
BOOL func_110(BOOL bParam0) // Position - 0x3573 (13683)
{
	bParam0;
