	...
	switch (iLocal_824)
	{
		case 92:
			...
			if (distanceBetweenCoords < 100f)
			{
				...
				num = { Global_113382 + (num * (float)100 - SYSTEM::ROUND(distanceBetweenCoords)), Global_113382.f_1 + (num.f_1 * (float)100 - SYSTEM::ROUND(distanceBetweenCoords)), Global_113382.f_2 };
...
void func_112(int iParam0) // Position - 0x5F23 (24355)
{
	...
	if (SYSTEM::VDIST2(outPosition, Global_113382) > 2f)
