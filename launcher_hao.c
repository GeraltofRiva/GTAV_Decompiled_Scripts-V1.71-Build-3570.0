...
BOOL func_213(Any* panParam0, BOOL bParam1) // Position - 0xD8F8 (55544)
{
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_79990 == true)
		return true;
...
int func_255(Ped pedParam0, eCharacter echParam1) // Position - 0xF55B (62811)
{
	int num;
...
BOOL func_257(eCharacter echParam0) // Position - 0xF5D2 (62930)
{
	int i;
