...
int func_20(int iParam0, Ped pedParam1) // Position - 0x6DE (1758)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_21(Global_101614) && pedParam1 != 0)
		{
			Global_101614 = 0;
		}
	}
...
void func_24() // Position - 0x821 (2081)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(character) && !func_19(14) || Global_113292)
			{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_55(Global_114344.f_2367.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_55(Global_114344.f_2367.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_55(Global_114344.f_2367.f_539.f_2314[2]), 32);
			return true;
