...
float func_15() // Position - 0x7C1 (1985)
{
	...
	fLocal_24 = SYSTEM::COS((3.14159f / 180f) * uLocal_18) * (Global_23692.f_1 - uLocal_18.f_1);
	fLocal_25 = MISC::ATAN2(fLocal_23, fLocal_24);
...
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_23692, uLocal_18));
...
{
	fLocal_26 = SYSTEM::SQRT(((Global_23692 - uLocal_18) * (Global_23692 - uLocal_18)) + ((Global_23692.f_1 - uLocal_18.f_1) * (Global_23692.f_1 - uLocal_18.f_1)));
	return fLocal_26;
}
