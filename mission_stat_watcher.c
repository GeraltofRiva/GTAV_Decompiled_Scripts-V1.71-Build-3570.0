...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBFA3 (49059)
{
	...
	if (!(num3.f_2 == 0))
	{
		num2 = SYSTEM::TO_FLOAT(SYSTEM::FLOOR((SYSTEM::TO_FLOAT(Global_76602[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f));
	...
	else
	{
		...
		switch (num3)
		{
			...
			case 5:
				func_96(uParam0, 13, str, "", SYSTEM::CEIL((SYSTEM::TO_FLOAT(Global_76602[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f), 0, num6, 0);
				break;
			...
			case 9:
				func_96(uParam0, 13, str, "", SYSTEM::ROUND(Global_76602[iParam1 /*9*/].f_2), 0, num6, 0);
				break;
...
void func_98(int iParam0) // Position - 0xD86E (55406)
{
	...
	if (iParam0 == 2)
	{
		num4 = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_1) * 0.78f);
	...
	for (i = 0; i < 5; i = i + 1)
	{
		...
		switch (Global_114344.f_1.f_126[iParam0 /*23*/].f_11[i])
		{
			...
			case 2:
			case 0:
				Global_114344.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_97743[num5 /*5*/].f_1) * 0.01f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		
			case 3:
				Global_114344.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_97743[num5 /*5*/].f_1) * 0.015f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		}
	}
	...
	switch (iParam0)
	{
		case 0:
			...
			Global_114344.f_1.f_126[0 /*23*/].f_2[1] = SYSTEM::CEIL(0.12f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_114344.f_1.f_126[0 /*23*/].f_2[1];
			Global_98088.f_7 = SYSTEM::CEIL(0.14f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
		...
		case 2:
			...
			Global_98088.f_7 = SYSTEM::CEIL(0.12f * (float)Global_114344.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_98088.f_7;
	...
	if (Global_114344.f_1.f_126[iParam0 /*23*/].f_6[0] != -1f)
		Global_114344.f_1.f_126[iParam0 /*23*/].f_6[0] = (SYSTEM::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_2[0]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_114344.f_1.f_126[iParam0 /*23*/].f_6[1] != -1f)
		Global_114344.f_1.f_126[iParam0 /*23*/].f_6[1] = (SYSTEM::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_2[1]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_114344.f_1.f_126[iParam0 /*23*/].f_6[2] != -1f)
		Global_114344.f_1.f_126[iParam0 /*23*/].f_6[2] = (SYSTEM::TO_FLOAT(Global_114344.f_1.f_126[iParam0 /*23*/].f_2[2]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_98088.f_6 != -1f)
		Global_98088.f_6 = (SYSTEM::TO_FLOAT(Global_98088.f_7) / SYSTEM::TO_FLOAT(value)) * 100f;
	...
	for (i = 0; i < Global_76601; i = i + 1)
	{
		if (Global_76602[i /*9*/].f_1 == 0)
			if (Global_76602[i /*9*/].f_2 != 0f)
				Global_76602[i /*9*/].f_1 = SYSTEM::FLOOR(Global_76602[i /*9*/].f_2);
		...
		if (num > 0)
		{
			if (Global_64731[num /*13*/] == 9)
				Global_76602[i /*9*/].f_1 = SYSTEM::ROUND(fLocal_632);
					...
					if (Global_64514)
						if (Global_64516 == -1 || Global_76602[i /*9*/] == Global_64516)
							if (Global_76602[i /*9*/] == 339 || Global_76602[i /*9*/] == 179 || Global_76602[i /*9*/] == 342 || Global_76602[i /*9*/] == 234)
								Global_76602[i /*9*/].f_1 = Global_76602[i /*9*/].f_1 + SYSTEM::ROUND(MISC::GET_FRAME_TIME() * 1000f);
							else
								Global_76602[i /*9*/].f_1 = Global_76602[i /*9*/].f_1 + iLocal_624;
					break;
