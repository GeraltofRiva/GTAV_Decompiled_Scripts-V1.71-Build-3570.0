...
ePedComponentType func_77(ePedComponentType epctParam0) // Position - 0x9A67 (39527)
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_78(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9B17 (39703)
{
	int i;
	var unk;
...
struct<17> func_81(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA5B8 (42424)
{
	int i;
	var unk;
