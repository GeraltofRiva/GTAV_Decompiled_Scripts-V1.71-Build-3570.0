			...
			if (Global_99237[iLocal_16] != PLAYER::PLAYER_PED_ID())
			{
				if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_99237[iLocal_16]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Global_99237[iLocal_16], false) || !ENTITY::IS_ENTITY_ATTACHED(Global_99237[iLocal_16]))
					{
						...
						{
							echLocal_17 = _GET_PLAYER_CHARACTER_FROM_PED(Global_99237[iLocal_16]);
								...
								if (echLocal_17 != _GET_CURRENT_PLAYER_CHARACTER())
								{
									if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(Global_99237[iLocal_16], PLAYER::PLAYER_PED_ID(), 17))
									{
										if (PED::IS_PED_IN_ANY_VEHICLE(Global_99237[iLocal_16], false))
											vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(Global_99237[iLocal_16], false);
...
void func_11() // Position - 0x61E (1566)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_8(character) && !func_12(14) || Global_113292)
			{
