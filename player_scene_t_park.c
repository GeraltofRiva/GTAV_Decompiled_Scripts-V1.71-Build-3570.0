...
void func_17(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2671 (9841)
{
	...
	{
		func_32(pedParam0, hash2, false, -1082130432);
		func_29(hash2, hash2, 0.3f, func_30(), caParam1, false);
...
void func_19(int iParam0, int iParam1, int iParam2, Ped pedParam3, Hash hParam4, int iParam5) // Position - 0x27FF (10239)
{
	int num;
...
void func_24(Ped pedParam0, Hash hParam1) // Position - 0x2946 (10566)
{
	int num;
	int num2;
	...
	func_25(1, num, 2, hParam1);
	return;
}

void func_25(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x29C5 (10693)
{
	func_19(iParam0, iParam1, iParam2, 0, hParam3, 1);
	return;
}
...
void func_29(Hash hParam0, Hash hParam1, float fParam2, float fParam3, Cam caParam4, BOOL bParam5) // Position - 0x2A7D (10877)
{
	int gameTimer;
