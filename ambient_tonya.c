...
Hash func_84() // Position - 0x74E1 (29921)
{
...
int func_146(char* sParam0, int iParam1) // Position - 0xAE42 (44610)
{
	int num;
	const char* str;
	Hash hashKey;
...
int func_154(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB16B (45419)
{
	int i;
...
void func_155(int iParam0, int iParam1) // Position - 0xB2A2 (45730)
{
	int i;
...
BOOL func_167(eCharacter echParam0) // Position - 0xBB2E (47918)
{
...
BOOL func_170(eCharacter echParam0) // Position - 0xBCA0 (48288)
{
	if (Global_120[echParam0 /*10*/].f_8 != 187)
...
void func_184(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC3A6 (50086)
{
