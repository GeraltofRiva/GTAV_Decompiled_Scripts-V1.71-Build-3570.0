...
int func_165(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7F2E (32558)
{
	...
	{
		if (!func_181(Global_100332[echParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_182(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC1A5 (49573)
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
void func_194(var uParam0, int iParam1) // Position - 0xCDFD (52733)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_182(Global_114344.f_18537[i], &unk, &num))
			{
...
void func_206(eCharacter echParam0, int iParam1) // Position - 0xD8B1 (55473)
{
	int num;
...
void func_207(eCharacter echParam0) // Position - 0xD99E (55710)
{
...
void func_208(eCharacter echParam0) // Position - 0xD9E9 (55785)
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
...
BOOL func_211(eCharacter echParam0) // Position - 0xE156 (57686)
{
	Hash entityModel;
...
int func_220(Vector3 vParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0x117FF (71679)
{
	int i;
	float distanceBetweenCoords;
	float num;
...
void func_243(Ped pedParam0) // Position - 0x12F65 (77669)
{
	...
	if (func_102(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(pedParam0, SYSTEM::ROUND(((Global_114344.f_2367.f_539.f_290[character] / 100f) * (SYSTEM::TO_FLOAT(PED::GET_PED_MAX_HEALTH(pedParam0)) - 100f)) + 100f), 0, 0);
	}
...
void func_254(Ped pedParam0) // Position - 0x134D4 (79060)
{
	...
	if (func_102(character) && !PED::IS_PED_INJURED(pedParam0))
		Global_114344.f_2367.f_539.f_290[character] = ((SYSTEM::TO_FLOAT(ENTITY::GET_ENTITY_HEALTH(pedParam0)) - 100f) / (SYSTEM::TO_FLOAT(PED::GET_PED_MAX_HEALTH(pedParam0)) - 100f)) * 100f;
...
void func_268(eCharacter echParam0) // Position - 0x14D0E (85262)
{
	eCharacter i;
	var unk;
...
void func_269(eCharacter echParam0) // Position - 0x14DC7 (85447)
{
	eCharacter i;
	var unk;
...
int func_273(eCharacter echParam0) // Position - 0x150B6 (86198)
{
	eCharacter character;

	if (Global_120[echParam0 /*10*/].f_8 != 187)
	{
		if (func_279(echParam0, Global_21222) == 1)
		{
			func_278(echParam0, Global_21222, 0);
		
			if (func_277(echParam0, Global_21222) == 0)
			{
...
void func_274(eCharacter echParam0, eCharacter echParam1) // Position - 0x1510C (86284)
{
	eCharacter character;
...
void func_275(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x15141 (86337)
{
...
void func_276(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x15186 (86406)
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return;
...
int func_277(eCharacter echParam0, eCharacter echParam1) // Position - 0x151CB (86475)
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
void func_278(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x151F5 (86517)
{
...
int func_279(eCharacter echParam0, eCharacter echParam1) // Position - 0x15226 (86566)
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
			...
			if (IS_BIT_SET(iLocal_39, 2))
			{
				if (func_313("AH_2_EXT_ALT") && STREAMING::HAS_MODEL_LOADED(joaat("prop_laptop_01a")))
				{
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							obLocal_45 = Global_98365.f_28[0];
...
int func_334(eCharacter echParam0) // Position - 0x17B55 (97109)
{
	int i;
...
void func_337(var uParam0, int iParam1) // Position - 0x17CB6 (97462)
{
...
void func_347(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x1837D (99197)
{
	uParam0->f_1 = iParam1;
...
int func_348(int iParam0, int iParam1) // Position - 0x183E9 (99305)
{
	if (iParam0 > iParam1)
		return iParam0;
