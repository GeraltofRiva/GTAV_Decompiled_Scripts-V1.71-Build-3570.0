...
void func_6() // Position - 0x2D4 (724)
{
	...
	{
		if (Global_21210)
			func_7(Global_21203, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
		else
...
void func_8() // Position - 0x3D7 (983)
{
	...
	{
		if (func_5(FRONTEND_CONTROL, Global_21191, 0))
		{
			if (bLocal_58 && iLocal_60 == 0 && bLocal_59 == false)
			{
				...
				if (Global_21210)
				{
					func_7(Global_21203, "SET_SOFT_KEYS", 2f, 0f, 13f, -1f, -1f, "CELL_201" /*CALL*/, 0, 0, 0, 0);
					func_7(Global_21203, "SET_SOFT_KEYS", 3f, 1f, 14f, -1f, -1f, "CELL_213" /*NO*/, 0, 0, 0, 0);
				}
				else
				{
