...
BOOL func_11(Hash hParam0) // Position - 0x10C2 (4290)
{
	switch (hParam0)
	{
		case 167:
...
Hash func_12(Player plParam0) // Position - 0x10E8 (4328)
{
	if (func_14(plParam0))
...
BOOL func_25(Player plParam0, Hash hParam1) // Position - 0x131C (4892)
{
	Player player;
