...
float func_139(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x7C10 (31760)
{
...
BOOL func_181(Hash hParam0) // Position - 0x92CD (37581)
{
	int i;
	...
	switch (iLocal_94.f_2.f_1[iParam0 /*66*/].f_30)
	{
		case 0:
			...
			if (amount > 0)
			{
				...
				hLocal_461 = hLocal_461 + amount;
				func_302(2, hLocal_461);
			}
			break;
	...
	switch (iParam2)
	{
		...
		case 4:
			switch (iParam1)
			{
				...
				case 47:
					func_237(sParam0, iParam1, pedParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(1150) * Global_262145.f_2887), 3);
					break;
...
void func_251(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1A8E2 (108770)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_241(&Global_79527[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79725)
		{
			...
			func_241(&Global_79527[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_302(int iParam0, Hash hParam1) // Position - 0x32E47 (208455)
{
	if (hParam1 > 0)
	{
...
int func_321(Player plParam0) // Position - 0x33F62 (212834)
{
...
BOOL func_330(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x34483 (214147)
{
	int i;
...
void func_433() // Position - 0x361F6 (221686)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		if (iLocal_460 != 0 || hLocal_461 != 0 || iLocal_462 != 0 || iLocal_463 != 0 || iLocal_464 != 0 || uLocal_465[0] != 0 || iLocal_474 == 1)
			STATS::PLAYSTATS_CRATE_DROP_MISSION_DONE(31, iLocal_460, hLocal_461, iLocal_462, iLocal_463, iLocal_464, &uLocal_465, iLocal_474);
	}
