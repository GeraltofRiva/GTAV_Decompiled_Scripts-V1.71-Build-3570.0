...
void func_62(BOOL bParam0) // Position - 0x19B6 (6582)
{
	*bParam0 = 0;
...
void func_89(BOOL bParam0) // Position - 0x202E (8238)
{
	...
	func_90();
	func_99(Global_21203, "DISPLAY_VIEW", SYSTEM::TO_FLOAT(25), SYSTEM::TO_FLOAT(value), -1082130432, -1082130432, -1082130432);
