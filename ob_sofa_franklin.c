...
void func_24(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2288 (8840)
{
	...
	{
		func_39(pedParam0, hash2, false, -1082130432);
		func_36(hash2, hash2, 0.3f, func_37(), caParam1, false);
		...
		if (num == -1)
		{
			...
			if (!(num2 == -1))
				Global_45376[num2 /*5*/].f_4 = Global_45376[num2 /*5*/].f_4 + iParam2;
		}
	}
	else
	{
		...
		{
			Global_45557 = Global_45557 + hash2;
			func_31(pedParam0, hash2);
		}
	}
	...
	func_25(1, num5, 4, pedParam0, iParam2);
	return;
}
...
void func_26(int iParam0, int iParam1, int iParam2, Ped pedParam3, Hash hParam4, int iParam5) // Position - 0x2416 (9238)
{
	int num;
	...
	Global_45457[num /*6*/].f_4 = hParam4;
...
void func_31(Ped pedParam0, Hash hParam1) // Position - 0x255D (9565)
{
	int num;
	int num2;
	...
	if (num == -1)
	{
		...
		if (!(num2 == -1))
		{
			Global_45345[num2 /*6*/].f_3 = Global_45345[num2 /*6*/].f_3 + hParam1;
			Global_45345[num2 /*6*/].f_2 = Global_45345[num2 /*6*/].f_2 + hParam1;
		}
	
		return;
	}

	func_32(1, num, 2, hParam1);
	return;
}

void func_32(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x25DC (9692)
{
	func_26(iParam0, iParam1, iParam2, 0, hParam3, 1);
	return;
}
...
void func_36(Hash hParam0, Hash hParam1, float fParam2, float fParam3, Cam caParam4, BOOL bParam5) // Position - 0x2694 (9876)
{
	int gameTimer;
	...
	Global_45557 = gameTimer + hParam0;

	if (bParam5)
		if (hParam0 == -1)
			Global_45557 = -1;

	Global_45558 = hParam1;
