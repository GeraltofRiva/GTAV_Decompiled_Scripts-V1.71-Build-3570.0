...
void func_8() // Position - 0x331 (817)
{
	...
	if (!IS_BIT_SET(iLocal_125, 1) || PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL) || Global_1944485)
	{
		...
		if (Global_2647052.f_1593 == false)
			func_292(7);
		else
			func_292(6);
...
char* func_43(const char* sParam0) // Position - 0x4A42 (19010)
{
	return sParam0;
}
...
BOOL func_58(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x51BF (20927)
{
	if (hParam1 == -1)
		return true;
	...
	if (iLocal_126 == 0)
	{
		...
		if (Global_1983799.f_3 == 173)
		{
			...
			if (!*Global_262145.f_36710)
			{
				if (!*Global_262145.f_36711)
				{
					...
					{
						func_46(true, "RPA_MENU_O6", 0, true, false, false, false);
					}
					else
					{
						func_46(true, "RPA_MENU_O6", 0, false, false, false, false);
		...
		else if (Global_1983799.f_3 == 176)
		{
			...
			if (func_279(flag4, flag5))
				func_46(false, "RPA_MENU_O4", 0, true, false, false, false);
			else
				func_46(false, "RPA_MENU_O4", 0, false, false, false, false);
			...
			if (!*Global_262145.f_36708)
				func_46(2, "RPA_MENU_O5", 0, true, false, false, false);
			else
				func_46(2, "RPA_MENU_O5", 0, false, false, false, false);
...
Hash func_174() // Position - 0xB921 (47393)
{
	return func_82(6116, -1);
}

Hash func_175(Hash hParam0) // Position - 0xB931 (47409)
{
	switch (hParam0)
	{
		case joaat("microlight"):
...
void func_250(int iParam0, Hash hParam1, int iParam2) // Position - 0x1C066 (114790)
{
	if (iParam0 < 0)
		return;
	...
	hParam1 = hParam1 + 1;
	func_251(iParam0, hParam1, iParam2);

	if (iParam0 >= 547)
		return;

	if (iParam2 == func_30() || iParam2 == -1)
		Global_1940049[iParam0] = hParam1;
...
Hash func_316(int iParam0) // Position - 0x1E359 (123737)
{
...
Hash func_337(Player plParam0) // Position - 0x1EF30 (126768)
{
	if (func_31(plParam0))
...
void func_347(int iParam0, Hash hParam1, int iParam2) // Position - 0x1FEC1 (130753)
{
	if (iParam2 != -1)
		Global_2685685.f_4346.f_418[iParam0] = Global_2685685.f_4346.f_418[iParam0] + iParam2;
	else if (hParam1 != -1)
		Global_2685685.f_4346.f_418[iParam0] = hParam1;
	else
...
Hash func_348(int iParam0) // Position - 0x1FF1E (130846)
{
	switch (iParam0)
	{
		case 0:
...
Hash func_349() // Position - 0x20412 (132114)
{
...
Hash func_350() // Position - 0x20446 (132166)
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE(func_339(46), -1, false, 0) || func_337(PLAYER::PLAYER_ID()) == 194)
...
BOOL func_354(Hash hParam0) // Position - 0x2069F (132767)
{
	int i;
...
BOOL func_356(Hash hParam0) // Position - 0x206E7 (132839)
{
	int i;
