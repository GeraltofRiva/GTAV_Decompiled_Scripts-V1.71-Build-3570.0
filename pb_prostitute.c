...
char* func_326(const char* sParam0) // Position - 0xF1C0 (61888)
{
	return sParam0;
}
...
void func_453(var uParam0) // Position - 0x13CEB (81131)
{
	...
	if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_94, SCRIPT_TASK_ENTER_VEHICLE) != 1 || !func_501(iLocal_47, 8192) && SYSTEM::VDIST2(uLocal_91, offsetFromEntityInWorldCoords) > 0f)
	{
		if (func_561())
		{
...
void func_514() // Position - 0x14E3F (85567)
{
	...
	if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedLocal_94, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < Global_33436 || Global_33436 == 0f && iLocal_294 != 4)
	{
		Global_33436 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedLocal_94, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
