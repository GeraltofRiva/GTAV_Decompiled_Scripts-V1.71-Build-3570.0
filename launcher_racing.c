		...
		if (i == 1 || !Global_24131.f_6331)
		{
			...
			for (j = PV_COMP_HEAD; j <= type; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_116("CommonMenu", "Gradient_Nav", Global_24128 + (iParam5 * 0.5f), num40 + num44 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_24131.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24131.f_79[num16 /*6*/]) != 0)
										{
											...
											func_102(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, num45, flag5, flag4);
...
void func_96(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x5C84 (23684)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
char* func_119(const char* sParam0) // Position - 0x6F6A (28522)
{
	return sParam0;
}
...
void func_122(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7000 (28672)
{
	int num;
	float num2;
	float num3;
...
void func_125(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x7275 (29301)
{
	int num;
