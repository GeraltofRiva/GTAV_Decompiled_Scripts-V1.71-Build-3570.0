...
void func_61(const char* sParam0) // Position - 0x3110 (12560)
{
...
void func_83(Hash hParam0) // Position - 0x36D9 (14041)
{
	func_84(hParam0);
	return;
}

void func_84(Hash hParam0) // Position - 0x36E7 (14055)
{
	hParam0 > 0;
	return;
}
...
void func_101(var uParam0, var uParam1, var uParam2, Hash hParam3, int iParam4) // Position - 0x5431 (21553)
{
...
void func_102(Hash hParam0) // Position - 0x54AC (21676)
{
	Hash i;
	var unk;
			...
			if (PED::IS_PED_SITTING_IN_VEHICLE(NETWORK::NET_TO_PED(iLocal_67.f_2[iParam0 /*26*/].f_1), NETWORK::NET_TO_VEH(iLocal_67.f_2[iParam0 /*26*/])))
			{
				if (iLocal_67.f_2[iParam0 /*26*/].f_3 != -1 && NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iLocal_67.f_2[iParam0 /*26*/].f_3)))
				{
					if (iLocal_67.f_2[iParam0 /*26*/].f_3 == iLocal_1791)
					{
						...
						{
							if (func_175(PLAYER::PLAYER_ID()) >= hLocal_1999 && MONEY::NETWORK_CAN_SPEND_MONEY(hLocal_1999, false, false, true, -1, 0))
							{
								if (iLocal_67.f_2[iParam0 /*26*/].f_7 == 6)
									func_117(5, iParam0);
								else
...
void func_156(Hash hParam0, BOOL bParam1) // Position - 0x7599 (30105)
{
	int num;
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x76AB (30379)
{
	int num;
...
int func_162(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, Hash hParam5, int iParam6, int iParam7) // Position - 0x8037 (32823)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_163(int iParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4) // Position - 0x81E4 (33252)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
Hash func_175(Player plParam0) // Position - 0x861E (34334)
{
	Hash num;
...
{
	return SYSTEM::VDIST2(vParam1, func_211(iParam0)) < func_210(iParam0);
}
				...
				if (iParam0 == Global_9082[num /*15*/].f_11)
				{
					if (i == Global_9082[num /*15*/].f_4)
					{
						if (Global_9660[i] == 0)
						{
							...
							if (Global_2696533)
								if (num == 14)
									func_245(Global_21203, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23648), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_9082[num /*15*/].f_4)
					{
						if (Global_9660[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_245(Global_21203, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23654), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_79744)
								{
									...
									func_245(Global_21203, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21222)
									...
									func_245(Global_21203, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_9082[num /*15*/].f_10 == 57 && num == 24)
							{
								...
								func_245(Global_21203, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_245(Global_21203, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_9082[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_9082[num /*15*/], 0, 0, 0, 0);
							}
...
void func_245(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0xF701 (63233)
{
...
void func_262(BOOL bParam0) // Position - 0xFF4F (65359)
{
	*bParam0 = 0;
...
BOOL func_359(eCharacter echParam0) // Position - 0x13524 (79140)
{
...
Hash func_368() // Position - 0x1399B (80283)
{
