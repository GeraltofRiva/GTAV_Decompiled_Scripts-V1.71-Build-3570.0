...
void func_12(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x537 (1335)
{
...
BOOL func_14(int iParam0, int iParam1, BOOL bParam2) // Position - 0x592 (1426)
{
	if (iParam1 == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(int iParam0) // Position - 0x635 (1589)
{
	return iParam0->f_1;
}
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0x133E (4926)
{
	iParam0->f_1 = 0;
	return;
}
...
int func_124(Hash hParam0) // Position - 0x97F4 (38900)
{
	switch (hParam0)
	{
		case 0:
...
void func_299() // Position - 0x354B5 (218293)
{
	...
	func_300(&uLocal_120, 4494.8423f, -4522.1455f, 4.9819f, -10.7044f, 0.1567f, 155.8207f, "HS4_NIMB_ISD_LSA", 0, 0, 1, 0);
	return;
}
