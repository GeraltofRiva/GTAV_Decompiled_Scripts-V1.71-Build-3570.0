...
void func_12(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x539 (1337)
{
...
BOOL func_14(int iParam0, int iParam1, BOOL bParam2) // Position - 0x594 (1428)
{
	if (iParam1 == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(int iParam0) // Position - 0x637 (1591)
{
	return iParam0->f_1;
}
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0x1340 (4928)
{
	iParam0->f_1 = 0;
	return;
}
...
int func_124(Hash hParam0) // Position - 0x97FA (38906)
{
	switch (hParam0)
	{
		case 0:
...
void func_170(Ped pedParam0, Any* panParam1, BOOL bParam2, int iParam3) // Position - 0xC91F (51487)
{
	var unk;
	int characterType;
	BOOL flag;
...
Hash func_189(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13879 (79993)
{
	var outProp;
	int componentId;
	int num;
...
Hash func_193(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13E4B (81483)
{
	Hash i;
	Hash j;
...
Hash func_194(Ped pedParam0, int iParam1) // Position - 0x13EEC (81644)
{
...
Hash func_196(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13FA3 (81827)
{
	int pedPropIndex;
...
BOOL func_202(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x143C6 (82886)
{
	Hash entityModel;
	Hash hash;
	Hash hash2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79527[1 /*14*/] = { func_218(entityModel, iParam1, hParam2, -1) };
			...
			if (unk[num] != -99)
			{
				if (!func_202(pedParam0, num, unk[num]))
				{
							...
							if (!func_202(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_79527[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_206(entityModel, hParam2, 14, j, &unk, &Global_79527[2 /*14*/]))
											{
												Global_2883588 = hash2;
												Global_2883589 = hash3;
												return false;
					...
					else
					{
						...
						Global_79527[2 /*14*/] = { func_218(entityModel, num, hash, -1) };
					
						if (!func_206(entityModel, hParam2, num, hash, &unk, &Global_79527[2 /*14*/]))
						{
							Global_2883588 = hash2;
							Global_2883589 = hash3;
							return false;
...
BOOL func_203(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x14821 (84001)
{
	Hash componentHash;
...
BOOL func_204(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x148CA (84170)
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_205(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14972 (84338)
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x149C5 (84421)
{
	var unk;
	int i;
...
BOOL func_207(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14FC9 (85961)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_208(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x15246 (86598)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_209(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x1566B (87659)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_210(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1595E (88414)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_217(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1857B (99707)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
struct<14> func_218(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x185EC (99820)
{
	func_264();
...
void func_231(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1D4D6 (120022)
{
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_221(&Global_79527[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79725)
		{
			...
			func_221(&Global_79527[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
int func_274(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x34888 (215176)
{
	Hash componentHash;
...
void func_299(var uParam0) // Position - 0x354B5 (218293)
{
	...
	func_300(&uLocal_120, -1640.5961f, -3127.1133f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_LSA_LAND_VEL", 0, 1, uParam0->f_4, 0);
	return;
}

void func_300(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x35502 (218370)
{
...
void func_301(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x35532 (218418)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_302(var uParam0, int iParam1, char* sParam2) // Position - 0x3555F (218463)
{
