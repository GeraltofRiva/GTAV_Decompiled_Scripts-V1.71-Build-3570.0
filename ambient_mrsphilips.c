...
Hash func_84() // Position - 0x74BA (29882)
{
...
int func_147(char* sParam0, int iParam1) // Position - 0xAE38 (44600)
{
	int num;
	const char* str;
	Hash hashKey;
...
int func_155(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB161 (45409)
{
	int i;
...
void func_156(int iParam0, int iParam1) // Position - 0xB298 (45720)
{
	int i;
