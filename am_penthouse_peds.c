...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1579739 == 0 || func_28())
			func_25();
...
void func_46() // Position - 0x8474 (33908)
{
	...
	Global_1579754 = Global_1579754 + 1;
	func_47(0, -1, false);
