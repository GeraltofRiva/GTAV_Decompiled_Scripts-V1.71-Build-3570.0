...
void main() // Position - 0x0 (0)
{
	...
	epctLocal_142 = Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_36;
	...
	{
		epctLocal_138 = func_229(PLAYER::PLAYER_ID());
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (epctLocal_142 == 126)
		{
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_389 > epctLocal_151)
				Global_1845225[epctLocal_138 /*874*/].f_260.f_389 = epctLocal_151;
		
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_389 != epctLocal_151 && func_225(epctLocal_138))
			{
				func_221(Global_1845225[epctLocal_138 /*874*/].f_260.f_389);
				func_216(true);
				iLocal_171.f_1 = 0.5f;
				iLocal_171 = 1;
		...
		{
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_390 > epctLocal_151)
				Global_1845225[epctLocal_138 /*874*/].f_260.f_390 = epctLocal_151;
		
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_390 != epctLocal_151)
			{
				func_221(Global_1845225[epctLocal_138 /*874*/].f_260.f_390);
				func_216(true);
				iLocal_171.f_1 = 0.5f;
				iLocal_171 = 1;
				iLocal_171.f_3 = iLocal_139;
		...
		{
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_386 > epctLocal_151)
				Global_1845225[epctLocal_138 /*874*/].f_260.f_386 = epctLocal_151;
		
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_386 != epctLocal_151)
			{
				func_221(Global_1845225[epctLocal_138 /*874*/].f_260.f_386);
				func_216(true);
				iLocal_171 = 1;
				iLocal_171.f_3 = iLocal_139;
				func_215();
...
{
	if (epctLocal_138 == PLAYER::PLAYER_ID() && func_214())
	{
	...
	if (iLocal_171.f_3 != iLocal_139)
	{
		...
		if (epctLocal_138 == PLAYER::PLAYER_ID() && iLocal_171.f_4)
		{
			if (epctLocal_142 == 126)
			{
				...
				Global_1845225[epctLocal_138 /*874*/].f_260.f_389 = iLocal_139;
			}
			else if (epctLocal_142 == 130)
			{
				func_26(41216, iLocal_139, -1);
				Global_1845225[epctLocal_138 /*874*/].f_260.f_390 = iLocal_139;
			}
			else
			{
				func_26(9355, iLocal_139, -1);
				Global_1845225[epctLocal_138 /*874*/].f_260.f_386 = iLocal_139;
			}
		}
	}
	...
	switch (iLocal_154)
	{
		...
		case 4:
			...
			else if (PED::GET_SYNCHRONIZED_SCENE_PHASE(localSceneFromNetworkId) >= 0.96f)
			{
				...
				if (epctLocal_142 == 126)
					epctLocal_150 = Global_1845225[epctLocal_138 /*874*/].f_260.f_389;
				else if (epctLocal_142 == 130)
					epctLocal_150 = Global_1845225[epctLocal_138 /*874*/].f_260.f_390;
				else
					epctLocal_150 = Global_1845225[epctLocal_138 /*874*/].f_260.f_386;
...
char* func_29() // Position - 0x12DB (4827)
{
	...
	else if (Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_36 != PV_COMP_INVALID)
	{
...
ePedComponentType func_44(ePedComponentType epctParam0) // Position - 0x29A6 (10662)
{
...
ePedComponentType func_46() // Position - 0x2A23 (10787)
{
...
int func_49(ePedComponentType epctParam0) // Position - 0x2A73 (10867)
{
	if (epctParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
int func_50(ePedComponentType epctParam0) // Position - 0x2A98 (10904)
{
	if (epctParam0 == _INVALID_PLAYER_INDEX())
		return -1;
...
ePedComponentType _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x2ABD (10941)
{
	return Global_1888737[PLAYER::PLAYER_ID() /*611*/].f_10;
}

void func_52(ePedComponentType epctParam0) // Position - 0x2AD2 (10962)
{
		...
		if (i == 1 || !Global_24131.f_6331)
		{
			...
			for (j = PV_COMP_HEAD; j <= type; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_97("CommonMenu", "Gradient_Nav", Global_24128 + (iParam5 * 0.5f), num40 + num44 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_24131.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24131.f_79[num16 /*6*/]) != 0)
										{
											...
											func_80(flag, Global_24131.f_1616[num16], Global_24131.f_1873[num16], flag7, num45, flag5, flag4);
...
void func_74(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x625D (25181)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL func_88(ePedComponentType epctParam0) // Position - 0x6D1C (27932)
{
	Player player;
...
char* func_100(const char* sParam0) // Position - 0x75FF (30207)
{
	return sParam0;
}
...
void func_103(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x7695 (30357)
{
	int num;
	float num2;
	float num3;
...
void func_106(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x790A (30986)
{
	int num;
...
void func_117() // Position - 0x7DEF (32239)
{
	...
	else if (epctLocal_141 == iLocal_171.f_3 && func_214())
	{
...
void func_121(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x7F59 (32601)
{
	ePedComponentType i;
	int num;
...
BOOL func_133(ePedComponentType epctParam0) // Position - 0x89EC (35308)
{
...
void func_138() // Position - 0x8C2A (35882)
{
	...
	if (isControlJustPressed)
	{
		...
		switch (iLocal_153)
		{
			...
			case 0:
				if (epctLocal_141 != iLocal_171.f_3 || !func_214() && !func_133(epctLocal_141))
				{
...
void func_139(ePedComponentType epctParam0) // Position - 0x8F02 (36610)
{
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, ePedComponentType epctParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F85 (36741)
{
	int num;
...
int func_141(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, ePedComponentType epctParam5, int iParam6, int iParam7) // Position - 0x9910 (39184)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_142(int iParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x9ABD (39613)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_144(ePedComponentType epctParam0) // Position - 0x9B49 (39753)
{
	epctParam0->f_65 = 0;
...
int func_150(ePedComponentType epctParam0) // Position - 0x9E9B (40603)
{
	var address;
...
char* func_152(ePedComponentType epctParam0) // Position - 0x9ECD (40653)
{
	switch (epctParam0)
	{
		case 0:
...
char* func_153(ePedComponentType epctParam0) // Position - 0x9FE4 (40932)
{
	switch (epctParam0)
	{
		case 0:
...
char* func_154(ePedComponentType epctParam0) // Position - 0xA0FB (41211)
{
	switch (epctParam0)
	{
		case 0:
...
ePedComponentType func_156() // Position - 0xA1F2 (41458)
{
	int num;
...
void func_157(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xA23B (41531)
{
	if (MISC::IS_PC_VERSION() && !NETWORK::NETWORK_TEXT_CHAT_IS_TYPING())
	{
		...
		if (func_161())
		{
			if (Global_4543037 == epctLocal_141)
			{
				*uParam2 = 1;
			}
			else
			{
				epctLocal_141 = Global_4543037;
				func_121(epctLocal_141, true, 1);
			}
		}
...
BOOL func_203() // Position - 0xB761 (46945)
{
	...
	if (func_252(PLAYER::PLAYER_ID()) && !func_225(epctLocal_138))
		flag = false;
...
void func_212() // Position - 0xB9BE (47550)
{
	...
	if (!func_207())
		if (epctLocal_142 == 126)
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_389 == iLocal_171.f_3 && !func_214() && Global_1845225[epctLocal_138 /*874*/].f_260.f_389 == epctLocal_151)
				iLocal_171.f_4 = 0;
		else if (epctLocal_142 == 130)
			if (Global_1845225[epctLocal_138 /*874*/].f_260.f_390 == iLocal_171.f_3 && !func_214() && Global_1845225[epctLocal_138 /*874*/].f_260.f_390 == epctLocal_151)
				iLocal_171.f_4 = 0;
		else if (Global_1845225[epctLocal_138 /*874*/].f_260.f_386 == iLocal_171.f_3 && !func_214() && Global_1845225[epctLocal_138 /*874*/].f_260.f_386 == epctLocal_151)
			iLocal_171.f_4 = 0;
...
void func_216(BOOL bParam0) // Position - 0xBC43 (48195)
{
	...
	if (func_6(epctLocal_142, -1))
		func_220(epctLocal_142, bParam0);
	else if (epctLocal_142 == 126)
		func_219(bParam0);
	else if (epctLocal_142 == 130)
		func_217(bParam0);
...
void func_220(ePedComponentType epctParam0, BOOL bParam1) // Position - 0xBD2B (48427)
{
	if (func_5(epctParam0) == 97)
	{
...
void func_221(int iParam0) // Position - 0xBD84 (48516)
{
	if (func_6(epctLocal_142, -1))
	{
		if (iParam0 != epctLocal_151 && iParam0 != -1)
		{
			...
			func_224(epctLocal_142, iParam0);
		}
...
void func_224(ePedComponentType epctParam0, int iParam1) // Position - 0xBEB2 (48818)
{
	char* radioStation;
...
BOOL func_225(ePedComponentType epctParam0) // Position - 0xBF2D (48941)
{
	return func_227(epctParam0) && func_226(epctParam0);
}

BOOL func_226(ePedComponentType epctParam0) // Position - 0xBF46 (48966)
{
...
BOOL func_227(ePedComponentType epctParam0) // Position - 0xBF7A (49018)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_1845225[epctParam0 /*874*/].f_260.f_433.f_1, 2);
...
ePedComponentType func_229(ePedComponentType epctParam0) // Position - 0xBFAB (49067)
{
	int num;
...
ePedComponentType func_230(ePedComponentType epctParam0) // Position - 0xC03D (49213)
{
	if (func_88(epctParam0))
...
BOOL func_231(ePedComponentType epctParam0, BOOL bParam1) // Position - 0xC060 (49248)
{
	if (!func_88(epctParam0))
		return false;
	...
	return func_88(Global_1888737[epctParam0 /*611*/].f_10);
}

BOOL func_232(ePedComponentType epctParam0) // Position - 0xC098 (49304)
{
	if (func_88(epctParam0))
		if (func_88(Global_1888737[epctParam0 /*611*/].f_10))
			return Global_1888737[epctParam0 /*611*/].f_10 == epctParam0;

	return false;
}

int func_233(ePedComponentType epctParam0) // Position - 0xC0CD (49357)
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_244(ePedComponentType epctParam0) // Position - 0xC877 (51319)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
void func_245() // Position - 0xC8DD (51421)
{
	...
	else if (epctLocal_142 != Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_36)
	{
		func_253(false);
	}
...
BOOL func_247(ePedComponentType epctParam0) // Position - 0xCB32 (52018)
{
...
BOOL func_248(ePedComponentType epctParam0) // Position - 0xCB6B (52075)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_249(ePedComponentType epctParam0) // Position - 0xCB9C (52124)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_251(ePedComponentType epctParam0) // Position - 0xCBD9 (52185)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658016[epctParam0 /*467*/].f_324.f_8 != PV_COMP_INVALID)
				return func_233(Global_2658016[epctParam0 /*467*/].f_324.f_8) == 26;
